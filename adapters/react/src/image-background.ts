...
import { dlog, flattenStyle } from '@symbiote/engine'
import { View } from './components'
import { Image, type IImageProps } from './image'
import type { IDimensionValue, IStyleProp, IViewStyle } from './styles'
...
const ABSOLUTE_FILL: IViewStyle = { position: 'absolute', left: 0, right: 0, top: 0, bottom: 0 }

function readDimension(style: Record<string, unknown>, key: 'width' | 'height'): IDimensionValue | undefined {
