...
import type { IShareContent, IShareOptions, IShareAction, IShareStatic } from './share-shared'

export type { IShareContent, IShareOptions, IShareAction } from './share-shared'
