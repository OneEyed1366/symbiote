...
// any of it, and — crucially — we don't mark anything "third-party": there is no
...
function resolve(name: string): IResolved {
  ...
  if (registrations) for (const registration of registrations) applyRegistration(registration, resolved)
